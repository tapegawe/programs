# Automatic Wi-Fi setting script running on Windows PowerShell
#
...
# 2. This script must be executed with administrator privileges since it controls the Windows service.
# 3. This file must be saved in "UTF8-BOM" encoding format for Korean to be displayed properly.
#
#
# Version 1.2
# Last modified on 2022-01-18
# Written by Byungho Park at 9Sapiens.
